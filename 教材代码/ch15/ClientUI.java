...
import java.awt.*;
public class ClientUI extends JFrame{//用户界面ClientUI
  JTextArea mainArea;
  JTextArea sendArea;
  ChatClient client;
  JTextField ipArea; 
...
this.client = client; 
  ...
  public ClientUI(){
    ...
    btnLink.addActionListener( new ActionListener(){
		  	public void actionPerformed(ActionEvent ae) {	//连接服务器，启动线程
...
class ChatClient extends Thread{//通讯类ChatClient负责守候数据到来
